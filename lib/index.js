...
module.exports = function(source, options) {
	...
	var self = {
		...
		skip: function(count) {
			_pos = Math.max(_pos + count, _len - 1);
			return _pos;
		},
		...
		isWs: function() {
			//\t \n \r \s
			return _ccode === 9 || _ccode === 10 || _ccode === 13 || _ccode === 115;
		},
		...
		to: function(count) {
			return _src.substr(0, _pos += count);
		}
